...
cp board/myir/myd_c437x_idk/uEnv.txt $BINARIES_DIR/uEnv/uEnv.txt
cp board/myir/myd_c437x_idk/uEnv_mmc.txt $BINARIES_DIR/uEnv/uEnv_mmc.txt
cp board/myir/myd_c437x_idk/uEnv_ramdisk.txt $BINARIES_DIR/uEnv/uEnv_ramdisk.txt
