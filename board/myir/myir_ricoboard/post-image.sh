...
cp ./output/build/linux-feature-ricoboard/arch/arm/boot/zImage ./boot
cp ./output/build/linux-feature-ricoboard/arch/arm/boot/dts/myir_ricoboard.dtb ./boot
cp ./output/build/linux-feature-ricoboard/arch/arm/boot/dts/myir_ricoboard_hdmi.dtb ./boot
...
tar rvf $BINARIES_DIR/matrix-rootfs.tar ./boot/myir_ricoboard.dtb
tar rvf $BINARIES_DIR/matrix-rootfs.tar ./boot/myir_ricoboard_hdmi.dtb
gzip -9 -c $BINARIES_DIR/matrix-rootfs.tar  > $BINARIES_DIR/matrix-rootfs.tar.gz
rm -rf ./lib/modules/4.1.18
rm -rf ./tmp/
rm ./boot/zImage
rm ./boot/myir_ricoboard.dtb
rm ./boot/myir_ricoboard_hdmi.dtb
