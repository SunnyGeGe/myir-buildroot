...
cp board/myir/myd_y335x/MLO_nand $BINARIES_DIR/MLO_nand
cp board/myir/myd_y335x/MLO_sd $BINARIES_DIR/MLO_sd
cp board/myir/myd_y335x/MLO_usbmsc $BINARIES_DIR/MLO_usbmsc
#cp board/myir/myd_y335x/u-boot.img $BINARIES_DIR/u-boot.img
cp board/myir/myd_y335x/u-boot_sd.img $BINARIES_DIR/u-boot_sd.img
cp board/myir/myd_y335x/u-boot_emmc.img $BINARIES_DIR/u-boot_emmc.img
cp board/myir/myd_y335x/u-boot_nand.img $BINARIES_DIR/u-boot_nand.img
cp board/myir/myd_y335x/u-boot_usbmsc.img $BINARIES_DIR/u-boot_usbmsc.img
cp board/myir/myd_y335x/readme.txt $BINARIES_DIR/readme.txt
